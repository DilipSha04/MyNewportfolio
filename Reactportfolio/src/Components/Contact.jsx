...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_4e1pnm3', 'template_lscg90h', formRef.current, 'W8SB5r_DJuoLaOGtW')
      .then((result) => {
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>imdilip04@outlook.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Adress</h2>
          <span>Umaria Disrtrict, M.P</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91 7987489510</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        ...
        >
          <input type="text" required id="" placeholder="Name"  name="name" />
